...
class DeviceControllerSpec extends Specification{
  ...
  "DeviceController" should {
    ...
    "populate the analogue in for the device" in new WithApplication {
      ...
      val changedThermometer:Device = TestDeviceController.populateAnalogueIn(thermometer)
    ...
    "populate the analogue out for the device" in new WithApplication {
      ...
      val changedHeater:Device = TestDeviceController.populateAnalogueOut(heater)
    ...
    "populate the digital out for the device" in new WithApplication {
      ...
      val changedPump:Device = TestDeviceController.populateDigitalOut(pump)
      ...
      val changedPump2:Device = TestDeviceController.populateDigitalOut(pump)
    ...
    "populate the digital in for the device" in new WithApplication {
      ...
      val changedSwitch:Device = TestDeviceController.populateDigitalIn(switch)
